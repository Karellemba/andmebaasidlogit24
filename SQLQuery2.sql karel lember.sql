...
---näitab kõikide tööliste palga kokku arvutuna
select sum(cast(Salary as int)) from Employees
---näitab kõige väiksema palga
...
--left join, ühest tabelist võetakse kõike isegi kui tesises tabelis on nullid
select  managerName, name, salary
from employees e left join manager m
ON e.managerID=m.Id

--right join ,võtab employees nullid ja näitb manager
select  managerName, name, salary
from employees e right join manager m
ON e.managerID=m.Id

-- full outer join, mõleal pool näitab nullid kas employees või manager
select  name, managerName, salary
from employees e full outer join manager m
ON e.managerID=m.Id

--cross join,näitab mõlemad tabelid ja korrutab need , kirjed, mõlemad tabelid
select  name, managerName, salary
